    ...
    if (n == 1) {
        ...
        if (m == 3) {
            ...
            if (a == 1) {
                ...
                printf("Discovred By Henry Cavendish\n");
                printf("Charge : +1\n");
            }
        }
    }
        ...
        if (Exit == 6) {
            ...
            if (Exi==4){
                ...
                printf("Periodic table has not closed and you can continue to learn more about elemnets\n\n");
        ...
        printf("Periodic table has not closed and you can continue to learn more elemnts\n\n");

        printf("Enter the atomic number of the elements to searched : ");
        scanf("%d", &a);
